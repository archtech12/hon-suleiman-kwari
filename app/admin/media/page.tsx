...
export default function MediaManager() {
  ...
  const handleUpdateMedia = async (e) => {
    ...
    try {
      const token = localStorage.getItem('adminToken');
      const response = await fetch(`http://localhost:5000/api/media/${editingMedia._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <form onSubmit={editingMedia ? handleUpdateMedia : handleCreateMedia} className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              {item.type === 'image' ? (
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentElement.innerHTML = '<span class="material-symbols-outlined text-4xl text-gray-400">image</span>';
                  }}
                />
              ) : (
        ...
        {mediaItems.length === 0 && (
          <div className="col-span-full text-center py-12">
            <span className="material-symbols-outlined text-4xl text-gray-400 mb-4">imagesmode</span>
